...
def generate_truth_table(binary_input):
    lexicographical_order = [f"{i:04b}" for i in range(16)]
    
    truth_table = [(lexicographical_order[i], int(binary_input[i])) for i in range(16)]
...
binary_input = "1001011101010101"

truth_table = generate_truth_table(binary_input)
